	...
	<div class="menu">
		<div>
			...
			<div class="container" style="margin-left: 0px;">
				<div class="row">
					<c:forEach var="productOffice" items="${productOffice }">
						<div class="col-md-3 mb-2 mt-2">
							<div class="card" style="width: 18rem; height: 700px">
								<a href="${base }/ChiTietSP/${productOffice.id }"><img
									style="width: 250; height: 350px;" class="card-img-top"
									src="${base }/upload/${productOffice.avatar }" alt="Card image cap"></a>
								<div class="card-body">
									<h5 class="card-title" style="margin-top: 10px">${productOffice.title }</h5>
									<h4 class="card-title" style="margin-top: 10px">Giá tiền:
										${productOffice.price } VNĐ</h4>
									<h5 class="card-title" style="color: black; margin-top: 10px">Số
										lượng: ${productOffice.quantity }</h5>
									<p class="card-text">${productOffice.short_description }</p>
									<a href="${base }/ChiTietSP/${productOffice.id }"
