	...
	<div class="menu">
		<div>
			...
			<div class="container" style="margin-left: 0px;">
				<div class="row">
					<c:forEach var="productClothes" items="${productClothes }">
						<div class="col-md-3 mb-2 mt-2">
							<div class="card" style="width: 18rem; height: 700px">
								<a href="${base }/ChiTietSP/${productClothes.id }"><img
									style="width: 250; height: 350px;" class="card-img-top"
									src="${base }/upload/${productClothes.avatar }" alt="Card image cap"></a>
								<div class="card-body">
									<h5 class="card-title" style="margin-top: 10px">${productClothes.title }</h5>
									<h4 class="card-title" style="margin-top: 10px">Giá tiền:
										${productClothes.price } VNĐ</h4>
									<h5 class="card-title" style="color: black; margin-top: 10px">Số
										lượng: ${productClothes.quantity }</h5>
									<p class="card-text">${productClothes.short_description }</p>
									<a href="${base }/ChiTietSP/${productClothes.id }"
