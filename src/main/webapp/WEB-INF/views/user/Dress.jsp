						...
						<div class="col-md-3 mb-2 mt-2">
							<div class="card" style="width: 18rem; height: 700px">
								<a href="${base }/ChiTietSP/${productdress.id }"><img
									...
									src="${base }/upload/${productdress.avatar }" alt="Card image cap"></a>
								<div class="card-body">
									<h5 class="card-title" style="margin-top: 10px">${productdress.title }</h5>
									<h4 class="card-title" style="margin-top: 10px">Giá tiền:
										${productdress.price } VNĐ</h4>
									<h5 class="card-title" style="color: black; margin-top: 10px">Số
										lượng: ${productdress.quantity }</h5>
